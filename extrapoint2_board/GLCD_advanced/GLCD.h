...
#define Orange				 RGB565CONVERT(255, 178, 102)
#define FleshPink			 RGB565CONVERT(255, 229, 204)
#define Brown				   RGB565CONVERT(153, 76, 0)
#define Pink				   RGB565CONVERT(255, 102, 178)
...
void LCD_SetPixel(uint16_t Xpos,uint16_t Ypos,uint16_t point, uint16_t dim);
